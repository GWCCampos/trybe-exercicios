...
// lucro (valor de venda descontado o custo do produto) a empresa terá ao vender mil desses 
// produtos.
...
const cProduto = 10;
const cPTotal = cProduto + (cProduto * 20 /100)
const vVenda = 20;
let vTotal = vVenda * 1000;
let lucro = vTotal - cPTotal;

 if (cProduto < 0 || vVenda < 0) {
   console.log('erro')
 }
